...
def training():
    ...
    for f in os.listdir("core/colour_detection/training_dataset/red"):
        color_histogram_of_training_image("core/colour_detection/training_dataset/red/" + f)

    # yellow color training images
    for f in os.listdir("core/colour_detection/training_dataset/yellow"):
        color_histogram_of_training_image("core/colour_detection/training_dataset/yellow/" + f)

    # green color training images
    for f in os.listdir("core/colour_detection/training_dataset/green"):
        color_histogram_of_training_image("core/colour_detection/training_dataset/green/" + f)

    # orange color training images
    for f in os.listdir("core/colour_detection/training_dataset/orange"):
        color_histogram_of_training_image("core/colour_detection/training_dataset/orange/" + f)

    # white color training images
    for f in os.listdir("core/colour_detection/training_dataset/white"):
        color_histogram_of_training_image("core/colour_detection/training_dataset/white/" + f)

    # black color training images
    for f in os.listdir("core/colour_detection/training_dataset/black"):
        color_histogram_of_training_image("core/colour_detection/training_dataset/black/" + f)

    # blue color training images
    for f in os.listdir("core/colour_detection/training_dataset/blue"):
        color_histogram_of_training_image("core/colour_detection/training_dataset/blue/" + f)
